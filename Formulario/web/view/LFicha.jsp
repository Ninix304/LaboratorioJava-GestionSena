                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-danger" href="../ControladorFicha?accion=editar&id=<%=fi.getCodFicha()%>">EDITAR</a>
                            <a class="btn btn-warning" href="../ControladorFicha?accion=eliminar&id=<%=fi.getCodFicha()%>">ELIMINAR</a>
                        </td>
                    </tr>
                    <% } %>                    
                </tbody>
